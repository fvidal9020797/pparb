...
<body>
	<div class="container" align ="center" >
		...
		<div class="row" style="margin-top:50px">
			<div class="col-sm-12">
				<div class="row">
					<h3>IMPRIMIR FORMULARIO RCIA</h3>
					<p class="a-negro">IMPRESION DEL FORMULARIO DE REPORTE DE CUMPLIMIENTO INDIVIDUAL ANUAL - RCIA</p>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<form  id="form"  action="/sistema/reportes/Report_Predios_1.php"  method="POST" name="form-asignacion" id="form-asignacion" enctype="multipart/form-data"   class="cmxform" >
							<div class="row">
								<div class="col-sm-6">
	                                <div class="form-group div-text-align">
	                                    <label class="a-negro">CODIGO PARCELA:</label>
	                                    <input type="text" id="codigorcia" name="codigorcia" class="form-control" placeholder="Codigo Parcela..." required>
	                                </div>
	                       		</div>
	                       		<div class="col-md-6" style="vertical-align: bottom;">
	                                <div class="form-group div-text-align" style="vertical-align: bottom;">
	                                     <label class="a-negro">BUSCAR:</label>
	                                    <input onclick="javascript:buscar1();" style="width: 100%;" name="submitLogin" type="button" value="BUSCAR PARCELA" class="btn btn-primary">
	                                </div>
	                        	</div>
							</div>
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group a-negro div-text-align">
	                                    <label class="a-negro">NOMBRE DE PARCELA:</label>
	                                    <input disabled="disabled" type="text"   name="nombre" id="nombre" class="form-control" placeholder="esperando." required>
	                                </div>
	                        	</div>
														<div class="col-md-6">
							                                <div class="form-group div-text-align">
							                                     <label class="a-negro">AÑO DE MONITOREO:</label>
							                                    <select   name="comboAno2" id="comboAno2" class="form-control"    ></select>
							                                </div>
							                            </div>
							</div>
							<div class="row">
	                        	...
	                        	<div class="col-md-12">
	                                <div class="form-group div-text-align">
		                                <label class="a-negro">IMPRIMIR:</label>
		                                <input style="width: 100%;" id="cerrar"  name="rcia" id="printrcia" type="submit" value="IMPRIMIR" class="btn btn-primary">
	                                </div>
	                            </div>
							</div>
							<div class="row">
								<div class="form-group">
	                            	<p id="msjError" style="color: red; text-align: left; text-align:center; "></p>
	                            </div>
							</div>
						</form>
					</div>
...
<script type="text/javascript">
  function buscar1(){
   //alert('buscar');
 idreg_=document.getElementById('codigorcia').value;
 idreg_=idreg_.trim();
  document.getElementById('msjError').innerHTML ="";
    ...
    if (idreg_.length > 2) {
       ...
       //   document.getElementById('msjError').innerHTML ="No se Encuentra la Parcela con ese Código";
    }
}
