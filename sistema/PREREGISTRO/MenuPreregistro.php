...
<tr><td>
	...
	?>
    	<td bgcolor="<?php if(isset($_GET["aux"]) && $_GET["aux"]<=1) {echo "#032c02";} else {echo "#75af73";} ?>" class="demo3"><font color="#FFFFFF"><b><a href="MenuPreregistro.php?aux=1">Lista de Carpetas en Preregistro</a></b></font></td>

    	<td bgcolor="<?php if(isset($_GET["aux"]) && $_GET["aux"]==2 ) {echo "#032c02";} else {echo "#75af73";} ?>" class="demo3"><font color="#FFFFFF"><b><a href="MenuPreregistro.php?aux=2">Nueva Carpeta de Preregistro</a></b></font></td>
...
switch ($opc)
	{case 1: $m="ListarPreregistro.php";break;   // Listado de Notas
	 case 2: $m="N_Preregistro.php?nuevo=0";break; // devuelve una nueva nota
	 case 3: $m="N_Preregistro.php?";break;  //Mantiene la pagina actual
	 default: $m="ListarPreregistro.php";
	}
