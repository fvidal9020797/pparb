...
<html >
           ...
           <?php    
            ...
            <!-- Main -->
                    <section id="main" class="container 80%">
                        ...
                        <b>
                         LISTADO DE ASIGNACIÓN DE ACTIVOS FIJOS                  
                        </b>
                            
                        </div>
                        <div class="texto"  align="center; " style="margin-top:-40px; padding: 0px; text-align: center;" >                        
                            <input  onclick="javascript:cargarListadoAsignacion(1,0,0);"   id="btnbuscar" style=" padding: 2px; text-align: center; width: 150px; " type="button" value="BUSCAR" />
                        </div>
                                                        ...
                                                        <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" abbr="Starter" style="width:8%;">Codigo<input Style="height:20px;font-size:11px;" type="text" value="" name="buscarcoducab" id="buscarcod" >                                                                       
                                                                        ...
                                                                        <th style="width:15%;" scope="col" abbr="Business">Departamento<select  name="buscarsubgrupo" id="buscardpto"  Style="height:20px;font-size:11px;"  >   </select>  </th>
                                                                        <th style="width:15%;" scope="col" abbr="Business">Regional <select  name="buscarobs"  id="buscarregional"  Style="height:20px; font-size:11px;"  >   </select>  </th>
                                                                        <th style="width:13%;" scope="col" abbr="Business">Area  <select  name="buscararea"  id="buscararea"  Style="height:20px; font-size:11px;"  >   </select>  </th>
                                                                        <th style="width:3%;" scope="col" abbr="Business">#Activos</th>
                                                                        <th style="width:4%;" scope="col" abbr="Business">Ver</th>
                                                                        <th style="width:4%;" scope="col" abbr="Business">Imprimir </th>
                                                                </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
 ...
 <script language="JavaScript">
  ...
  cargarcomboListadoAsignacion(); 
  cargarListadoAsignacion(1,0,0);
 </script>
