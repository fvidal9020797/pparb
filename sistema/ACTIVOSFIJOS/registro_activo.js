   ...
   var filtro="";
     ...
     bfecha = document.getElementById('buscarfecha').value;
        ...
        if(bcodobs >0){            
          ...
          if(bnombre.length>0){            
              bnombre=bnombre.toUpperCase();
             filtro=filtro+"  and  upper(na.nombreactivo) like '%"+bnombre.trim()+"%'";
        }
...
function CargaEditarUno(){
    ...
    var prodId = getParameterByName('id');
     ...
     // alert('aaa');
     $('#cbosubgrupo').prop('disabled', 'disabled');
     $('#cbogrupo').prop('disabled', 'disabled');
...
function insertarUltima_ext(name, pagina ,ini,fin) {
 ...
 function cargarnameregionalAS(){
     namep=document.getElementById('cboregionalAS').options[document.getElementById('cboregionalAS').selectedIndex].text;
     document.getElementById('nameregionalAS').value=namep;
}


 function cargarnamepersonalAS(){
     namep=document.getElementById('cboPersonalAS').options[document.getElementById('cboPersonalAS').selectedIndex].text;
     document.getElementById('nameperAS').value=namep;
}
