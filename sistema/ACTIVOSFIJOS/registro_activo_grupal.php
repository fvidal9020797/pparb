...
<html >
	<head>
		<title>Activos fijos - (Grupal)</title>
		<meta charset="utf-8" />
           ...
           <?php    
            ...
            <!-- Main -->
                    <section id="main" class="container 75%">
                        ...
                        <b>
                            <big> <label class="accionm"><span class="accionsombra" id="idtitulo" style="font-size:16px; ">NUEVO</span></label> REGISTRO DE ACTIVOS FIJOS (Grupal)</big>
                        </b>
                        </div>
                                                    ...
                                                    <div class="6u 12u(mobilep)" >
                                                          <div class="row uniform 50%">
                                                              <div  style="width: 20%;" >
                                                               ...
                                                               <div  style="width: 80%;" >
                                                                   <input type="text" name="idcantidad" id="idcantidad" required="required"  onkeypress="return blockNonNumbers_a(this, event, true, false);"  value="" placeholder="0" />
                                                                </div>
                                            ...
                                            <div class="row uniform">
                                                <div class="12u" style="padding-top:10px; text-align:center; ">
                                                            <ul class="actions align-center">
                                                                <li><input id="btnguardarind" onclick="javascript:guardarGrupal();"  style=" padding: 5px; text-align: center; height:50px; width: 250px; " type="button" value="GUARDAR" /></li>
                                                            </ul>
                                                    </div>
                                            </div>
                                    </form>
...
<div id="dialogo2" class="ventana" style="  padding-top: -10px; display:none;  " title="GESTION">
    ...
    <form  style=" margin-top:-20px;padding-top: -10px;"  id="form" action="/sistema/reportes/Report_Predios_1.php" method="POST" name="form-asignacion" id="form-asignacion" class="cmxform" >
				...
				<div id="recuadro" class="col plomo" style="height:100px;" ><!--
...
<div id="contextsub"  >
        <ul>
            ...
            <li><a class="monitoreo" id="subgrupo" idaccion="Editar" href="#">Editar</a></li>
             <li><a href="javascript:eliminarsubGrupo();">Eliminar</a></li>
        </ul>
    </div>  
