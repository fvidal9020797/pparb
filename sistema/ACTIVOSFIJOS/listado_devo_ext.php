...
<html >
            ...
            <!-- Main -->
                    <section id="main" class="container 80%">
                        ...
                        <b style="font-size:12px; " >
                         LISTADO DE ACTIVOS FIJOS DE <span id="idtp" name="idtp" </span>                         
                        </b>
                            
                        </div>
                        <div class="texto"  align="center; " style="margin-top:-40px; padding: 0px; text-align: center;" >                        
                            <input  onclick="javascript:cargarListadoActivoD_ext(1,0,0);"   id="btnbuscar" style=" padding: 2px; text-align: center; width: 150px; " type="button" value="BUSCAR" />
                        </div>
                                                        ...
                                                        <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" abbr="Starter" style="width:8%; font-size:10px; ">Codigo Ucab<input Style="height:20px; font-size:10px;" type="text" value="" name="buscarcoducab" id="buscarcoducab" >  </th>
                                                                        ...
                                                                        <th style="width:13%; font-size:10px; " scope="col" abbr="Business">Grupo <select name="buscargrupo" id="buscargrupo"  Style="height:20px; font-size:10px;"  >   </select>  </th> 
                                                                        <th style="width:13%; font-size:10px;" scope="col" abbr="Business">Sub-Grupo <select  name="buscarsubgrupo" id="buscarsubgrupo"  Style="height:20px; font-size:10px;"  >   </select>  </th>
                                                                        <th style="width:13%; font-size:10px; " scope="col" abbr="Business">Observación<select  name="buscarobs"  id="buscarobs"  Style="height:20px; font-size:10px;"  >   </select>  </th>                                                                         
                                                                          <th style="width:13%; font-size:10px;" scope="col" abbr="Business">Caracteristica</th>    
                                                                </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
 ...
 <script language="JavaScript">
  ...
  cargarcomboListadoTodosD(); 
  cargarListadoActivoD_ext(1,0,0);
 </script>
 <div id="nav">
