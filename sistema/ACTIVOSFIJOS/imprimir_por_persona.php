...
$idnp_=  "";
     ...
     //  $resultado="si"; 
    $idr_= $_POST["cboregional"];
    $idp_= $_POST["cboPersonal"];
    $idnr_= $_POST["nameregional"];
    $idnp_= $_POST["nameper"];
 ...
 //echo "entrooo7=".$id_;
   ...
   function imprimirPorsubGrupo($idr_,$idnr_, $idp_,$idnp_ ){
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//activos-fijos//reprote_por_personal_regional_p.jasper';
	//Ruta a donde deseo Guardar Mi archivo de salida Pdf
	$SalidaReporte='C://xampp//htdocs//PPARB//sistema//reportes//activos-fijos//'.$filename;
	//Parametro en caso de que el reporte no este parametrizado
	$Parametro=new java('java.util.HashMap');
 ...
 //echo "entrooo7=".$id_;
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//activos-fijos//reprote_por_personal_regional_p2.jasper';
	//Ruta a donde deseo Guardar Mi archivo de salida Pdf
	$SalidaReporte='C://xampp//htdocs//PPARB//sistema//reportes//activos-fijos//'.$filename;
	//Parametro en caso de que el reporte no este parametrizado
	$Parametro=new java('java.util.HashMap');
