            ...
            <!-- Main -->
                    <section id="main" class="container 80%">
                        ...
                        <div class="texto"  align="center; " style="margin-top:-40px; padding: 0px; text-align: center;" >                        
                            <input  onclick="javascript:cargarListadoActivo(1,0,0);"   id="btnbuscar" style=" padding: 2px; text-align: center; width: 150px; " type="button" value="BUSCAR" />
                        </div>
                                                    ...
                                                    <table id="tableActivo" class="table1" >
                                                        <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" abbr="Starter" style="width:7%;">Codigo Ucab<input Style="height:20px; font-size:11px;" type="text" value="" name="buscarcoducab" id="buscarcoducab" >                                                                       
                                                                        </th>
                                                                        ...
                                                                        <th style="width:8%;" scope="col" abbr="Medium">Fecha Compra<input Style="height:20px;font-size:11px;" type="text" value="" name="buscarcodm" id="buscarfecha"  > </th>                                                                        
                                                                        <th style="width:18%;" scope="col" abbr="Business">Nombre<input  Style="height:20px;font-size:11px;" type="text" value="" name="buscarnombre" id="buscarnombre"  > </th> 
                                                                        <th style="width:15%;" scope="col" abbr="Business">Grupo   <select name="buscargrupo" id="buscargrupo"  Style="height:20px;font-size:11px;"   >   </select>   </th> 
                                                                        <th style="width:15%;" scope="col" abbr="Business"  >Sub-Grupo  <select  name="buscarsubgrupo" id="buscarsubgrupo"  Style="height:20px;font-size:11px;"  >   </select>  </th>
                                                                        <th style="width:8%;" scope="col" abbr="Business">Observación<select  name="buscarobs"  id="buscarobs"  Style="height:20px;font-size:11px;"  >   </select>  </th>
                                                                         <th style="width:6%;" scope="col" abbr="Business">Estado<select  name="buscares"  id="buscares"   Style="height:20px;font-size:11px;"  >   </select>  </th>
                                                                        <th style="width:5%;" scope="col" abbr="Business">Editar </th>
                                                                </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
