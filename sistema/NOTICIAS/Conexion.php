...
class Conexion {
  ...
  private function __construct() {
   ...
   // $hostname_mdryt = "localhost";
    ...
    $cn = pg_connect("host={$hostname_mdryt} port={$port} dbname={$database_mdryt} user=postgres password=ucabdsw") or trigger_error("Nombre de Usuario o Contrase�a  no v�lidos.",FATAL);
    $this->conexion= $cn;
  }
