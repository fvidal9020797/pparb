...
<body>
          ...
          <table width="90%" align="center" border="0">
            <tr>
              <td width="92%" class="texto" align="center"><b><big>GENERAR PRELIQUIDACION O PLAN DE PAGO</big></b> <br>
C&oacute;digo Parcela: <?php echo $row_parcela['idparcela']; ?> </td>
          ...
          <table width="90%" border="0" class='taulaA' align="center" cellspacing="0">
            ...
            <tr class="texto_normal">
              <td width="19%"  id='blau'>NOMBRE DEL PREDIO:<br> UBICACION GEOGRAFICA:              </td>
