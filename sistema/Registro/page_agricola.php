				  ...
				  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++/
...

					{
					  $insertaux=sprintf("insert into auxiliar values(%s, %s, %s);",
												 GetSQLValueString($_SESSION['idreg'], "int"),
												 GetSQLValueString("plancultivo", "text"),
												 GetSQLValueString('3,'.GetSQLValueString($_SESSION['datos_agricola']['cultivo'.$i],"int").','.$_SESSION['idreg'].','.  $_SESSION['datos_agricola']['SupVerano1'.$i].','.$_SESSION['datos_agricola']['SupInvierno1'.$i], "text"));
					$Result2 = pg_query($cn, $insertaux);
						   $insertaux=sprintf("insert into auxiliar values(%s, %s, %s);",
												 GetSQLValueString($_SESSION['idreg'], "int"),
												 GetSQLValueString("plancultivo", "text"),
												 GetSQLValueString('4,'.GetSQLValueString($_SESSION['datos_agricola']['cultivo'.$i],"int").','.$_SESSION['idreg'].','. $_SESSION['datos_agricola']['SupVerano2'.$i].','. $_SESSION['datos_agricola']['SupInvierno2'.$i], "text"));
					$Result2 = pg_query($cn, $insertaux);
					 $insertaux=sprintf("insert into auxiliar values(%s, %s, %s);",
												 GetSQLValueString($_SESSION['idreg'], "int"),
												 GetSQLValueString("plancultivo", "text"),
												 GetSQLValueString('5,'.GetSQLValueString($_SESSION['datos_agricola']['cultivo'.$i],"int").','.$_SESSION['idreg'].','.  $_SESSION['datos_agricola']['SupVerano3'.$i].','. $_SESSION['datos_agricola']['SupInvierno3'.$i], "text"));
					$Result2 = pg_query($cn, $insertaux);
							$insertaux=sprintf("insert into auxiliar values(%s, %s, %s);",
												 GetSQLValueString($_SESSION['idreg'], "int"),
												 GetSQLValueString("plancultivo", "text"),
												 GetSQLValueString('6,'.GetSQLValueString($_SESSION['datos_agricola']['cultivo'.$i],"int").','.$_SESSION['idreg'].','. $_SESSION['datos_agricola']['SupVerano4'.$i].','. $_SESSION['datos_agricola']['SupInvierno4'.$i], "text"));
					$Result2 = pg_query($cn, $insertaux);
							$insertaux=sprintf("insert into auxiliar values(%s, %s, %s);",
												 GetSQLValueString($_SESSION['idreg'], "int"),
												 GetSQLValueString("plancultivo", "text"),
												 GetSQLValueString('7,'.GetSQLValueString($_SESSION['datos_agricola']['cultivo'.$i],"int").','.$_SESSION['idreg'].','. $_SESSION['datos_agricola']['SupVerano5'.$i].','. $_SESSION['datos_agricola']['SupInvierno5'.$i], "text"));
					$Result2 = pg_query($cn, $insertaux);
...
if(!isset($_SESSION['datos_agricola'])){
	...
	"
	select
		a.supverano AS supverano3,
		a.supinvierno AS supinvierno3,
		b.supverano AS supverano4,
		b.supinvierno AS supinvierno4,
		c.supverano AS supverano5,
		c.supinvierno AS supinvierno5,
		d.supverano AS supverano6,
		d.supinvierno AS supinvierno6,
		e.supverano AS supverano7,
		e.supinvierno AS supinvierno7,
		a.idcultivo
		from
