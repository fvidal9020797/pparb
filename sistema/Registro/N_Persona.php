...
<select name="annoIni" class="combos"  id="annoIni" onChange="return dia_mes_ano('diaIni','mesIni','annoIni');">
  ...
  <tr>
   ...
   <?php if( (isset($_SESSION['datos_persona']['tipoperjuridica'])&& (  ($_SESSION['datos_persona']['tipoperjuridica']==185) || ($_SESSION['datos_persona']['tipoperjuridica']==18)   )) || (isset($row_persona['tipoperjuridica']) &&  ( ($row_persona['tipoperjuridica']==18) || ($row_persona['tipoperjuridica']==185) )     )){ ?>
  <tr   class="TituloCajaNegocios" >
