...
function mostraropcionrcia(seleccion) {
	try
    {
...
<table width="90%" border="0" class='taulaA' align="center" cellspacing="0">
		...
		<tr >
                ...
                <tr class="taulaA"  id='blau3' >
                      ...
                      <td ><textarea disabled name="cite" id="cite" cols="50" rows="1"><?php echo isset($_SESSION['datos_nota_ext']['cite']) ? htmlspecialchars($_SESSION['datos_nota_ext']['cite']) : "";?></textarea></td>
                </tr>
                  ...
                  if($totalRows_listado>0){
                   ...
                   ?>
                         <tr>
                           ...
                           <td width="10%"> <?php echo trim($row_listado['accion']);?>
                              <input id="<?php echo "accion"; echo trim($row_listado['idderivado']);?>" value="<?php echo trim($row_listado['idaccion']);?>"  type="hidden"></input>
                              <input id="<?php echo "accionrcia"; echo trim($row_listado['idderivado']);?>" value="<?php echo trim($row_listado['rcia']);?>"  type="hidden"></input>
                           </td>
         ...
         <td id='blau'>
           ...
           <div id="iddivderivar" <?php    echo "style='display:none;'"; ?> >
             <table width="100%" cellspacing="0"   border="0">
                 ...
                 <tr class="taulaA"  id='blau3'>
                     <td width="44%" align="right" id="blau3">Fecha Derivacion:</td>
                     <td  width="56%"  align="left" id='blau3'>
                  ...
                  <tr class="taulaA"  id='blau3'>
                      ...
                      <td > <table  >
                              <tr>
                                ...
                                <td>
                                   <input  style="width:20px; height:20px; vertical-align:top;" type="checkbox" name="chekRCIA" id="chekRCIA" value="check"
                                   onChange="mostraropcionrcia(this);"
                                   <?php if (!(empty($_SESSION['datos_nota_ext_d']['chekRCIA']))) { if($_SESSION['datos_nota_ext_d']['chekRCIA']==268 || $_SESSION['datos_nota_ext_d']['chekRCIA']==269 || $_SESSION['datos_nota_ext_d']['chekRCIA']==266 || $_SESSION['datos_nota_ext_d']['chekRCIA']==267 ){ echo " checked='checked' ";}  } ?> >
                                </td>



                                <td name = "opcionrcia" id="opcionrcia" <?php if(isset($_SESSION['chekRCIA']) && $_SESSION['chekRCIA']<>0){?> style="display:table-row" <?php } else { ?>  style="display:none"; <?php } ?>>
...
function guardarDerivacion(){
  ...
  comboaccion=document.getElementById("comboaccion").value;
    comboaccionrcia=document.getElementById("comboaccionrcia").value;
  ...
  var parametros = {
               ...
               "proveido" : proveido,
               "comboaccionrcia" : comboaccionrcia
       };
       $.ajax({
               data:  parametros,
...
//  alert(document.getElementById('fechaderivacion'+idd).innerHTML);
  ...
  seleccionarComboId('comboaccionrcia',document.getElementById('accionrcia'+idd).value);

  var a = document.getElementById('accionrcia'+idd).value;
  //alert(a);
  if( a != '0')
  {
    document.getElementById('chekRCIA').checked = true;
    document.getElementById("opcionrcia").style.display = "block";
  }
