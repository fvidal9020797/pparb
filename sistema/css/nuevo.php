 ...
 <div  class="center" style="width:75% ">
    <form id="example-advanced-form" action="#" method="post">
     ...
     <div class="line" ></div>  
        ...
        <h3>Identificar Predios para monitoreo</h3>
        <fieldset>
...
<tr class="header">
  <th><strong>#</strong></th>
  <th><strong>CODIGO  <input id="b_codigo" name="b_codigo" type="text"
                class="required" placeholder="" autofocus="" title=""
                value="<?php echo htmlspecialchars(@$_SESSION['ctform']['b_codigo']) ?>"/> 
  </strong></th>
  <th><strong>NOMBRE <input id="b_nombre" name="b_nombre" type="text"
                class="required" placeholder="" autofocus="" title=""
