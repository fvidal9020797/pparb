...
function ImprimirNotaPuntuacion($idnota,$tipo)
	{
	require('ConexionImpresionesRegistro.php');

    $filename = "nota_puntuacion.pdf";
	...
	if($tipo == 0)
	{
			$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reporte-notas//Formulario_Nota_Puntuaciongabinete.jasper';
	}
	else
	{
		  $Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reporte-notas//Formulario_Nota_Puntuacioncampo.jasper';
	}
