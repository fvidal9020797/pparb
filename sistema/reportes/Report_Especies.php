...
if (isset($_REQUEST['report-especie-restituir'])) {
    ...
    switch ($caso) {
        case 'pdf':
            ...
            $filename = 'report_especie_restituir_all';
            $japerReport = 'report_especie_restituir_all.jasper';
...
if (isset($_REQUEST['report-especie-restituir-groupby'])) {
    $caso = $_REQUEST['outputtype'];
    switch ($caso) {
        case 'pdf':
            /* inicio descargar en pdf */
            $estado = $_REQUEST['estado'];
            $filename = 'report_especie_restituir_cantidad';
            $japerReport = 'report_especie_restituir_cantidad.jasper';
            $report_parametro_1 = NULL;
            $report_parametro_2 = NULL;
            $report_parametro_3 = NULL;
            $report_parametro_4 = NULL;
...
<HTML>
    ...
    <BODY>
        <div id="tabs">
            <ul>
                <li><a href="#tabs-1">Listado de Especies a Restituir</a></li>
            </ul>
            ...
            <div id="tabs-1">
                <div class="menubar-main" align="center">
                    ...
                    <div class="" align="center">
                        <h1>Reporte Personalizado de Especies a Restituir</h1>
                        <form  method="post" id="form" action="Report_Especies.php">
                            <div id="general_filter">
                                <fieldset>
                                    ...
                                    <UL>
                                        ...
                                        <li id="campos">
                                            <?php echo $getSql->getCulumnaNames("report_especiesrestituir"); ?>
                                ...
                                <fieldset >
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <label for="estado">TIPO DE RESTITUCION:</label>
                                            <?php echo $codificador->getByClasificador(17); ?>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <input type="text" class="date-left" id="inicio" name="inicio" value=""/> <label style="float: left;padding-left: 10px;padding-right: 10px">Hasta</label><input class="date-left" type="text" id="fin" name="fin" value=""/>
                                        </li>
                                    </ul>
                                </fieldset>
                            ...
                            <p>
                                <input type="hidden" value="report_especiesrestituir" name="caso">
                                <input type="submit" name="report-especie-restituir" value="Mostrar Reportes" class="limebutton ui-state-default ui-corner-all">
