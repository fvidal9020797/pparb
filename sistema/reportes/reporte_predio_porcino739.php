...
function ImprimirPredioPorcino739($CodigoParcela)
	{
    require('ConexionImpresionesRegistro.php');
    $filename = "Formulario_Porcino.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Porcino739//Predio_Porcino.jasper';
	...
	$jru->runReportToPdfFile($Reporte,$SalidaReporte,$Parametro,$Conexion);
        ...
        $filename = "Formulario_Porcino739.pdf";
