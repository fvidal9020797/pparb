...
function ImprimirPredioMixto739($CodigoParcela)
	{
    require('ConexionImpresionesRegistro.php');
    $filename = "Formulario_Mixto739.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Mixta739//Predio_Mixto.jasper';
