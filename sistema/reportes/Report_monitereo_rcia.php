    ...
    // exit();
      switch ($caso) {
        ...
        case 'xls':
               ...
               $titulo="REPORTE RCIA PRESENTADOS ";
...
if (isset($_REQUEST['reportDevuelta'])) {
  ...
  switch ($caso) {
        ...
        case 'xls':
               ...
               $titulo="REPORTE RCIA NO PRESENTADOS";
            $filename = 'report_no_presentaron_rcia';
            include("./exel-report.php");
            break;
        case 'html':
            $mensaje = "Funcion no implementada";
...
$(document).ready(function(){
 ...
 <script>
    ...
    <BODY>
         ...
         <div id="tabs">
            <ul>
                <li><a href="#tabs-1">RCIA Presentados</a></li>
		<li><a href="#tabs-2">Predio que no Presentaron RCIA</a></li> 
            </ul>
            ...
            <div id="tabs-1">
                ...
                <h1>Reporte Personalizado RCIAS presentados</h1>
                <form  method="post" id="form" action="Report_monitereo_rcia.php">
                            ...
                            <UL>
                                <li> <strong>Seleccionar Todos Los Campos </strong> <input type="checkbox" id="checkAll" name="" value=""> </li>
                                     ...
                                     <div class="col-9-1 ">
                                        ...
                                        <?php echo $getSql->getCulumnaNames("report_presentaron_rcia"); ?>
                                     </div>
                        ...
                        <fieldset >
                            ...
                            <ul>
                                ...
                                <li>
                                 ...
                                 <li>
                                    <label for="oficina">FECHA RCIA RECEPCIONADO:</label>
                    ...
                    <p>
                        ...
                        <input type="hidden" value="monitoreo.report_presentaron_rcia" name="caso">
 ...
 <div id='response'>
	     ...
	     <div id="tabs-2">
                <div class="menubar-main" align="center">
                    <h1></h1>
                  <div class="" align="center">
                <h1>Reporte Personalizado Predios que no Prestaron RCIA</h1>
                <form  method="post" id="form" action="Report_monitereo_rcia.php">
                    <div id="general_filter">
                        <fieldset>
                            <LEGEND>Seleccionar datos para mostrar</LEGEND>
                            <UL>
                                <li> <strong>Seleccionar Todos Los Campos </strong> <input type="checkbox" id="checkAll2" name="" value=""> </li>
                                     ...
                                     <div class="col-9-1 ">
                                        <p align="center"><STRONG >Datos generales</STRONG></p>
                                        <?php echo $getSql->getCulumnaNames("report_no_presentaron_rcia"); ?>
                                     </div>
 ...
 <li>
                                 ...
                                 <li>
                                    <label for="oficina">FECHA SUSCRIPCION:</label>
                    ...
                    <p>
                        ...
                        <input type="hidden" value="monitoreo.report_no_presentaron_rcia" name="caso">
