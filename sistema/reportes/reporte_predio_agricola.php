...
function ImprimirPredioAgricola($CodigoParcela)
	{
	require('ConexionImpresionesRegistro.php');
    
	//Obtener Fecha de Hoy
    $filename = "Formulario_Agricola.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Agricola//Predio_Agricola.jasper';
