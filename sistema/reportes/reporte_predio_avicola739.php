...
function ImprimirPredioAvicola739($CodigoParcela)
	{
    require('ConexionImpresionesRegistro.php');
    $filename = "Formulario_Avicola739.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Avicola739//Predio_Avicola.jasper';
