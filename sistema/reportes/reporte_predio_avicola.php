...
function ImprimirPredioAvicola($CodigoParcela)
	{
    require('ConexionImpresionesRegistro.php');
    $filename = "Formulario_Avicola.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Avicola//Predio_Avicola.jasper';
