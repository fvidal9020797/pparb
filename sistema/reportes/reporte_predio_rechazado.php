...
function ImprimirPredioRechazado($CodigoParcela)
	{
    require('ConexionImpresionesRegistro.php');
    $filename = "Formulario_Rechazado.pdf";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reportes//Rechazado//Rechazado.jasper';
