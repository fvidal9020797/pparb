...
function ImprimirNotaABT($idnota)
	{
	require('ConexionImpresionesRegistro.php');
	
    $filename = "Nota_de_Remision_ABT.odt";
	...
	$Reporte='C://xampp//htdocs//PPARB//sistema//reportes//reporte-notas//Formulario_Nota_ABT.jasper';
