...
//$resultado = $_POST['idnotaext'] ;
    ...
    if (($_POST["tarea"] == "establecerAnosG") )
   {
        
        $sql_mon= "select idmonitoreo,anho from monitoreo.monitoreo where   tipo=268 and estado = 1 and idregistro = ".$_SESSION['idreg']." order by anho asc";
