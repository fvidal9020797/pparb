...
?>
<div class="texto">
 <form action="documentos_ganadero.php" method="POST" autocomplete="off" name="form-docganarcia" id="form-docganarcia" enctype="multipart/form-data" >
 ...
 <table width="90%" border="0" class='taulaA' align="center">
  ...
  <tr class="texto_normal">
    <td id='blau8'>&nbsp;</td>
    <td colspan="2" id='blau'><span class="taulaH">Actividad Ganadera</span></td>
  </tr>
  ...
  <tr class="texto_normal">
    ...
    <td colspan="2" id='blau9'>
        ...
        <?php
					...
					$sql_documentos = "select * from codificadores where idclasificador = 35 and orden = 2 order by idcodificadores asc";
    		...
    		?>
                  ...
                  ?>
                    <td align="center" id="blau16">
                          ...
                          <?php
                          $aux = $row_docrciaganadera['presento'];
                          $auxano = $row_docrciaganadera['anho'];
                          ...
                          if ($auxano == $anoacti)
                          {
                                ...
                                <?php
                                  ...
                                  if(isset($row_docrciaganadera )){ $row_docrciaganadera = pg_fetch_assoc($rcia_doc_ganadera); }
  ...
  <tr class="texto_normal">
    <td id='blau8'>&nbsp;</td>
    <td colspan="2" id='blau'><textarea name="ObservacionDocGanaderas" id="ObservacionDocGanaderas" cols="200" rows="5"><?php echo trim($obsganaderarciadoc['obs']);?></textarea></td>
  </tr>
