...
<div class="texto">
 <form action="documentos_bosques.php" method="POST" autocomplete="off" name="form-docbosquercia" id="form-docbosquercia" enctype="multipart/form-data" >
 ...
 <table width="90%" border="0" class='taulaA' align="center">
  ...
  <tr class="texto_normal">
    <td id='blau8'>&nbsp;</td>
    <td colspan="2" id='blau'><span class="taulaH">Actividad Restitución de Bosques</span></td>
  </tr>
  ...
  <tr class="texto_normal">
    ...
    <td colspan="2" id='blau9'>
        ...
        <?php
					...
					$sql_documentos = "select * from codificadores where idclasificador = 35 and orden = 3 order by idcodificadores asc";
    		...
    		?>
                  ...
                  ?>
                    <td align="center" id="blau16">
                          ...
                          <?php
                          $aux = $row_docrciabosque['presento'];
                          $auxano = $row_docrciabosque['anho'];
                          ...
                          if ($auxano == $anoacti)
                          {
                                ...
                                <?php
                                  ...
                                  if(isset($row_docrciabosque )){ $row_docrciabosque = pg_fetch_assoc($rcia_doc_bosque); }
  ...
  <tr class="texto_normal">
    <td id='blau8'>&nbsp;</td>
    <td colspan="2" id='blau'><span class="taulaH">Otros:</span></td>
  </tr>


  <tr class="texto_normal">
    <td id='blau8'>&nbsp;</td>
    <td colspan="2" id='blau'><textarea name="ObservacionDocBosque" id="ObservacionDocBosque" cols="200" rows="5"><?php echo trim($obsbosquerciadoc['obs']);?></textarea></td>
  </tr>

</table>

          <input id="guardarstepdocbosquercia" class="boton verde formaBoton" type="submit" value="Guardar" name="guardarstepdocbosquercia">
</form>
</div>
